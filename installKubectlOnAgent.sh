...
#### We need to figure out how to set up the service account, until then we skip this and use Greg's credentials
...
#### Workaround for not having service account set up
...
echo '----> Agent access, execute the following and follow prompts'
